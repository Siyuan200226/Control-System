...
/* Private defines -----------------------------------------------------------*/
#define Dissolved_Oxygen_Sensor_Pin GPIO_PIN_0
#define Dissolved_Oxygen_Sensor_GPIO_Port GPIOA
#define Temp_Sensor_Pin GPIO_PIN_2
#define Temp_Sensor_GPIO_Port GPIOA
#define YF_S401_Pin GPIO_PIN_3
#define YF_S401_GPIO_Port GPIOA
#define YF_S401_EXTI_IRQn EXTI3_IRQn
...
#define Vacuum_Pump_GPIO_Port GPIOB
